    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
            <header className="bg-slate-950 p-4 border-b border-slate-800 flex justify-between items-center sticky top-0 z-50 shadow-md">
                <Link href="/dashboard" className="text-slate-400 hover:text-white px-2 py-1 rounded-lg hover:bg-slate-800 transition-colors text-sm font-medium">
                    ← 뒤로
                </Link>
            ...
            <main className="flex-1">
                <AdminMemberView initialMembers={members} />
            </main>
        </div>
    )
}
